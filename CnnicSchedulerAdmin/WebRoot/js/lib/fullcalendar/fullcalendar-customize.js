/**
 * popupLayer.js弹窗层 //示例6，使用遮罩（此弹窗接口修改完全和排班管理模块绑定，建议其他外部功能不要使用） new
...
// 月表body Month
	...
	function buildWeekBodyHTML() {
		...
		html += "<tbody>";
		// 获取排班人员分组
		var xhyGroup=Tiger.personGroupArrCache;
		// 获取班次颜色
		Tiger.cachingScheduleEvents(Tiger.calenderVisStart,Tiger.calenderVisEnd);
		Tiger.xhyEventsObj=Tiger.pidAndEventsMappingObjCache;
		// 行数=人员个数+组数
		...
		for (var i = 0; i < xhyGroup.length; i++) {
			...
			if(i==0){
				html += "<tr class='fc-week'><td class='fc-top-border fc-wed fc-widget-content fc-past' colspan='8'"+
			...
			for (var j = 0; j < xhyList.length; j++) {
				...
				" style='vertical-align: middle;font-weight: bold;color:gray;font-size: 16px;'><i class='glyphicon glyphicon-user'></i> "+pname+"</td>";
	...
	function buildWeekCalendarHTML(){
		...
		html += "<tr><th class='fc-sun fc-widget-header'>姓名</th>";
	...
	function buildWeekCellHTML(date,pid,personName) {
		...
		if(events){
			...
			for (var bc = 0; bc < eventArr.length; bc++) {
				// 获取该班次的颜色
				var bcColor=Tiger.planNameAndColorMappingObjCache[eventArr[bc]] || "#fff";
